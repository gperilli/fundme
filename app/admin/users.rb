ActiveAdmin.register User do
  ...
  permit_params :email, :user_number, :uid, :subscribed, :stripe_customer_id, :stripe_payment_method_id, :subscription_stage, :subscription_frequency, :username, :language
