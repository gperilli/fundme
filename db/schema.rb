...
ActiveRecord::Schema.define(version: 2022_09_11_111312) do
  ...
  create_table "ddpages", force: :cascade do |t|
    t.string "title"
  ...
  create_table "text_blocks", force: :cascade do |t|
    t.string "title"
    t.integer "order"
    t.bigint "ddpage_id", null: false
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.text "en"
    t.text "es"
    t.text "pt"
    t.index ["ddpage_id"], name: "index_text_blocks_on_ddpage_id"
  end
  ...
  add_foreign_key "text_blocks", "ddpages"
end
