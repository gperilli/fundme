...
# users
gareth = User.create!(email: "gareth@gperilli.dev", password: "password", username: "gareth", first_name: "Gareth", last_name: "Perilli")
...
SitewideText.create!(name: 'tag line', en: 'Support our project. Make a donation!', es: 'Apoya nuestro proyecto. ¡Haz una donación!', pt: 'Apoie nosso projeto. Faça uma doação!')
...
SitewideText.create!(name: 'payment page message', en: 'Make your donation.', es: 'Haz tu donación.', pt: 'Faça sua doação.' )
SitewideText.create!(name: 'donation completed message', en: 'Thank you for your donation.', es: 'Gracias por tu donación.', pt: 'Obrigado por sua doação.' )
...
SitewideText.create!(name: 'sign up page message', en: 'Sign up and start funding this project.', es: 'Regístrate y empieza a financiar este proyecto.', pt: 'Inscreva-se e comece a financiar este projeto.' )
SitewideText.create!(name: 'support us', en: 'Support Us', es: 'Apoyanos', pt: 'Apoie-nos')

subscription_parameters = SubscriptionParameter.create!(
